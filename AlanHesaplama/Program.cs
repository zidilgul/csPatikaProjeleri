...
namespace AlanHesaplama
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (n != -1)
            {
                ...
                Console.WriteLine("Çýkmak için -1 tuþlayýn");

                Console.Write("Þekil numarasý giriniz: ");
                ...
                switch (n)
                {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        Console.WriteLine("Hatalý giriþ yaptýnýz");
                        break;
    ...
    public class Methods
    {
        ...
        {
            Console.Write("Kenar uzunluðu giriniz: ");
            int k = int.Parse(Console.ReadLine());

            int area = k * k;

            Console.WriteLine("Karenin alaný: " + area);
        }

        public void CalculateAreaRectangle()
        {
            Console.Write("1.kenar uzunluðu giriniz: ");
            int k = int.Parse(Console.ReadLine());
            Console.Write("2.kenar uzunluðu giriniz: ");
        ...
        {
            Console.Write("Yarýçap uzunluðu giriniz: ");
